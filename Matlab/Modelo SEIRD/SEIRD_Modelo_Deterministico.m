...
% * P: Inmunes. 
% 
% En el caso del COVID-19 no se consideraban tan apropiadas las categorías 
% de inmunidad (P) y cuarentena (Q) no tienen sentido entonces se implementará 
% el denominado SEIRD. 
% 
% 
...
semilogy(tDias, E, 'g', tDias, I, 'r', tDias, R, 'b', tDias, D, 'k');
